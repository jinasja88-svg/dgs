  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="bg-surface rounded-[var(--radius-xl)] p-8 mb-12">
        <h2 className="font-heading text-2xl font-bold mb-4">우리의 미션</h2>
      ...
      <div className="text-center bg-primary-bg rounded-[var(--radius-xl)] p-8">
        <h2 className="font-heading text-2xl font-bold mb-4">함께하세요</h2>
        <p className="text-text-secondary mb-6">
          궁금한 점이 있으시면 언제든지 문의해주세요.
        </p>
        <a
          href="/contact"
          className="inline-flex items-center px-6 py-3 bg-primary text-white font-medium rounded-[var(--radius-md)] hover:bg-primary-hover transition-colors"
        >
          문의하기
        </a>
      </div>
